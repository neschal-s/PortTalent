...
const AppLayout = () => {
  return (
    <div>
      ...
      <div className='pt-5 pb-5 text-center bg-slate-950 mt-10'>
        <span className='text-xl font-light pb-5'>Connect with the developer:</span>
        <div className="flex justify-center">
          {/* GitHub Icon */}
          <span className="flex justify-center items-center">
            <a
              className="inline-flex items-center justify-center size-12 rounded-full hover:bg-accent hover:text-accent-foreground transition-colors"
              href="https://github.com/neschal-s"
              target="_blank"
              rel="noopener noreferrer"
            >
              <svg viewBox="0 0 438.549 438.549" className="size-5" fill="currentColor">
